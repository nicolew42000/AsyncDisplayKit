...
- (instancetype)init
{
  ...
  if (self) {
    ...
    FBAnimationPerformanceTrackerConfig config = [FBAnimationPerformanceTracker standardConfig];
    //config.reportStackTraces = YES;
    //_perfTracker = [[FBAnimationPerformanceTracker alloc] initWithConfig:config];
